...
\begin{centering}\includegraphics[min width=0.4\textwidth=0.6\textwidth,min height=0.4\textwidth=0.6\textwidth,keepaspectratio,max width=0.9\textwidth,max height=0.9\textwidth]{66/conflictpetri47bb63cb0231e8a3361e3b58708c9231bb7f67b73402a4e9a996482a4959978811011.pdf}\end{centering}
...
Geben Sie Ihre Antwort durch Angabe eines Paars von in Konflikt stehenden Transitionen und einer Liste aller Stellen, die den Konflikt verursachen. Die Angabe von 
\begin{minted}{text}
((t0,t1),[s0,s1])
\end{minted}
 als Antwort würde bedeuten, dass Transitionen t0 und t1 unter der Startmarkierung in Konflikt stehen
