...
spec = do
  describe "generateDeadlock" $ do
    ...
    it "has valid config for nightly test (allowedTokenChanges LT)" $ do
      let config = defaultDeadlockConfig {
            filterConfig = noFiltering,
    ...
    it "has valid config for nightly test (allowedTokenChanges GT)" $ do
      let config = defaultDeadlockConfig {
            filterConfig = noFiltering,
            transitionBehaviorConstraints = TransitionBehaviorConstraints {
    ...
    it "has valid config for nightly test (areNonPreserving)" $ do
      let config = defaultDeadlockConfig {
            filterConfig = noFiltering,
            transitionBehaviorConstraints = TransitionBehaviorConstraints {
